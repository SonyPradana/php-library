...
{
  /** @test */
  public function it_collection_functional_worK_properly(): void
  {
    $original = [
      'buah_1' => 'mangga',
      'buah_2' => 'jeruk',
  ...
  /** @test */
  public function it_collection_imutable_funtional_worK_properly(): void
  {
    $original = [
      'buah_1' => 'mangga',
      'buah_2' => 'jeruk',
  ...
  /** @test */
  public function it_collection_chain_work_great(): void
  {
    $origin = [0, 1, 2, 3, 4];
