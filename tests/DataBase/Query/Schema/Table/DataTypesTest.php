...
final class DataTypesTest extends TestDatabaseQuery
{
    ...
    public function itCanGenerateDateTimeDataTypes(): void
    {
        ...
        $expected = 'CREATE TABLE testing_db.test_datetime ( col_time time, col_time_len time(4), col_timestamp timestamp, col_timestamp_len timestamp(6), col_date date, col_datetime datetime, col_year year )';
        $this->assertEquals($expected, $schema->__toString());
    }
}
